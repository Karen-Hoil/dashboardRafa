            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '20px' }}>
                <thead>
                    <tr>
                        ...
                        <th style={{ backgroundColor: '#f2f2f2', padding: '10px', borderBottom: '1px solid #ddd' }}>Contraseña</th>
                        <th style={{ backgroundColor: '#f2f2f2', padding: '10px', borderBottom: '1px solid #ddd' }}>Acciones</th>
                    </tr>
                </thead>
                <tbody>
                    {/* Aquí irían tus datos de administradores */}
                    <tr>
                        <td style={{ padding: '10px', borderBottom: '1px solid #ddd' }}>1</td>
                        <td style={{ padding: '10px', borderBottom: '1px solid #ddd' }}>Admin 1</td>
